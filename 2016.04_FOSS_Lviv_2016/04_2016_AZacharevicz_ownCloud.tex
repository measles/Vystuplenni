...
\subsection{RSS}
\begin{frame}{RSS}
	Страшнаваты, але даволі функцыянальны вебінтэрфейс. Якім я, пашчасцю, не карыстаюся (апроч стварэння груп). А вось Андроід-кліент [15] вельмі зручны, функцыянальны і прыгожы. 
	\begin{center}
		\includegraphics[height=0.6\textheight,keepaspectratio]{RSS-1}{ }\includegraphics[height=0.6\textheight,keepaspectratio]{RSS-2}
	\end{center}
\end{frame}
